            ...
            <div className="card-content center">
              <div className="icon-block">
                ...
                <p>
                  ...
                  >
                    <p>
                      ...
                      steering position sensor for redundancy and to confirm
                      data. The ESC module must receive two signals to confirm
                      the steering wheel position. These signals are often out
                ...
                <p>
                  ...
                  >
                    <p>
                      ...
                      as early as model year 2002 and have become standardized
                      on most makes and models for model year 2019 and forward.
                      Types of systems can include lane keep assist, blind spot
                      detection, active cruise control, etc. These systems rely
                      on the use of numerous specialized sensors and cameras
                      that often require some form of calibration or programming
                      in order to operate properly after any type of service
                ...
                <p>
                  ...
                  >
                    <p>
                      Intelligent Cruise Control (ICC) measures the distance
                      from the vehicle ahead and controls acceleration and
                      deceleration to automatically maintain a suitable
                      following distance. This distance is adjusted according to
                      the speed of the vehicle ahead, up to the preset speed,
                      and the ICC speed settings set by the driver.
                    </p>
                  </Modal>
                </p>
                <p>
                  ...
                  >
                    <p>
                      ...
                      the vehicle and road, guaranteeing that in-car ADAS
                      systems receive accurate and reliable information.
                    </p>
                  </Modal>
                </p>
                <p>
                  ...
                  >
                    <p>
                      Adaptive headlights are an active safety feature designed
                      to make driving at night or in low-light conditions safer
                      by increasing visibility around curves and over hills.
                      When driving around a bend in the road, standard
                      headlights continue to shine straight ahead, illuminating
                      the side of the road and leaving the road ahead of you in
                      the dark. Adaptive headlights, on the other hand, turn
                      their beams according to your steering input so that the
                ...
                <p>
                  ...
                  >
                    <p>
                      The blind spot monitor is a vehicle-based sensor device
                      that detects other vehicles located to the driver’s side
                      and rear. Warnings can be visual, audible, vibrating, or
                      tactile. However, blind spot monitors are an option that
                      may do more than monitor the sides and rear of the
                      vehicle.
                    </p>
                  </Modal>
                </p>
                ...
                <p>
                  ...
                  >
                    <p>
                      Adaptive cruise control (ACC) is an available cruise
                      control system for road vehicles that automatically
                      adjusts the vehicle speed to maintain a safe distance from
                      vehicles ahead. As of 2019, it is also called by 20 unique
                      names that describe that basic functionality.
                    </p>
                  </Modal>
                </p>
                <br />
